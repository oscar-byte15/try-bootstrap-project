...
# 📖 Portfolio: Mobile menu<a name="my-project"></a>
...
Clone this repository to your desired folder: clone my project fromm github with the link of the project
...
To run the project, only open the index.html file on your browser
